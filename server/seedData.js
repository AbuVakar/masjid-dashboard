...
const demoResources = [
  ...
  },
  {
    ...
    description: "Complete Islamic calendar with prayer times and important dates",
    category: "Document",
  ...
  },
  {
    ...
    description: "Collection of Islamic education materials for children and adults",
    category: "Link",
...
const seedData = async () => {
  try {
    ...
    const totalMembers = savedHouses.reduce((total, house) => total + house.members.length, 0);
